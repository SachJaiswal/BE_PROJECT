    ...
    return (
        <div className="flex flex-col items-center gap-2 p-4" style={{ height: viewHeight }}>
            ...
            <div className="flex h-[90%] w-full flex-col gap-2">
                ...
                <div className="relative w-full">
                    <select
                        className="w-full rounded-md bg-darkHover px-4 py-2 text-white"
                    ...
                    <PiCaretDownBold className="absolute right-4 top-3 text-white" />
                </div>

                {/* INPUT */}
                <textarea
                    className="min-h-[100px] w-full bg-darkHover p-2 text-white"
                ...
                {/* RUN BUTTON */}
                <button
                    className="w-full bg-primary p-2 font-bold text-black"
                    onClick={runCode}
                    disabled={isRunning}
                >
                ...
                <pre className="flex-grow overflow-auto bg-darkHover p-2 text-white">
                    {output}
                </pre>
            </div>
        </div>
